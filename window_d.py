...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Використовуючи блок-схему алгоритму рис.1.6, або створену самостійно\n"
"блок-схему ефективнішого алгоритму, знайти різницю множин А та В. В\n"
