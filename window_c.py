...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Використовуючи блок-схему алгоритму рис.1.5, або створену самостійно\n"
"блок-схему ефективнішого алгоритму, виконати перетин множин A і В. В\n"
"результаті виконання перетину сформувати множину С. Вивести елементи\n"
"множини С."))
