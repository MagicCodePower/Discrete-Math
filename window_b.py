...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Task B:"))
        self.label_2.setText(_translate("MainWindow", "Results:"))
        self.label_3.setText(_translate("MainWindow", "C :"))
        self.pushButton.setText(_translate("MainWindow", "Back"))
        self.label_5.setText(_translate("MainWindow", "Використовуючи блок-схему алгоритму рис. 1.4 або створену самостійно\n"
"блок-схему ефективнішого алгоритму, виконати об’єднання множин A і B. В\n"
"результаті виконання об’єднання сформувати множину С. Вивести елементи\n"
"множини С."))
